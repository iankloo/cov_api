...
if(db_date != facts_date){
  ...
  if(good){
    ...
    county_shapes <- readRDS('/home/ubuntu/cov_api/data/all_counties.RDS')
    ...
    geojsonio::geojson_write(county_shapes, file = "/home/ubuntu/bigmap/ts.geojson")
    
    #setwd('/home/ubuntu/bigmap')
    #system('git add --all')
